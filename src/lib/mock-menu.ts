...
export const MOCK_MENU: PublicMenu = {
  ...
  order_page: {
    ...
    tiktok_username: "thebrewhouse",
    facebook_page_url: "https://facebook.com/thebrewhouse",
    media_gallery: [
      {
        id: "g-1",
        source: "facebook_photo",
        source_url: "https://www.facebook.com/thebrewhouse/photos/1",
        thumbnail_url: "https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=200&h=200&fit=crop&auto=format",
        embed_html: null,
        sort_order: 0,
        active: true,
      },
      {
        id: "g-2",
        source: "facebook_photo",
        source_url: "https://www.facebook.com/thebrewhouse/photos/2",
        thumbnail_url: "https://images.unsplash.com/photo-1509042239860-f550ce710b93?w=200&h=200&fit=crop&auto=format",
        embed_html: null,
        sort_order: 1,
        active: true,
      },
      {
        id: "g-3",
        source: "tiktok",
        source_url: "https://www.tiktok.com/@thebrewhouse/video/123456789",
        thumbnail_url: "https://images.unsplash.com/photo-1559305616-3f99cd43e353?w=200&h=200&fit=crop&auto=format",
        embed_html:
          '<blockquote class="tiktok-embed" cite="https://www.tiktok.com/@thebrewhouse/video/123456789" data-video-id="123456789" style="max-width:605px;min-width:325px;"><section><a target="_blank" href="https://www.tiktok.com/@thebrewhouse">@thebrewhouse</a><p>Latte art tutorial 🎨☕</p><a target="_blank" href="https://www.tiktok.com/@thebrewhouse/video/123456789">♬ original sound - The Brew House</a></section></blockquote> <script async src="https://www.tiktok.com/embed.js"></script>',
        sort_order: 2,
        active: true,
      },
      {
        id: "g-4",
        source: "facebook_photo",
        source_url: "https://www.facebook.com/thebrewhouse/photos/3",
        thumbnail_url: "https://images.unsplash.com/photo-1559056199-641a0ac8b55e?w=200&h=200&fit=crop&auto=format",
        embed_html: null,
        sort_order: 3,
        active: true,
      },
      ...
      items: [
        {
          ...
          image_urls: [
            "https://images.unsplash.com/photo-1577968897966-3d4325b36b61?w=600&h=450&fit=crop&auto=format",
            "https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=600&h=450&fit=crop&auto=format",
            "https://images.unsplash.com/photo-1509042239860-f550ce710b93?w=600&h=450&fit=crop&auto=format",
          ],
          is_available: true,
          variants: [],
        },
        ...
        },
        {
          ...
          image_urls: [
            ...
            "https://images.unsplash.com/photo-1559305616-3f99cd43e353?w=600&h=450&fit=crop&auto=format",
          ],
          is_available: true,
          variants: [],
        },
      ...
      items: [
        {
          ...
          image_urls: [
            "https://images.unsplash.com/photo-1555507036-ab1f4038808a?w=600&h=450&fit=crop&auto=format",
            "https://images.unsplash.com/photo-1568471173242-461f0a730452?w=600&h=450&fit=crop&auto=format",
          ],
          is_available: true,
          variants: [
